    ...
    <div className="container full-height-grow">
      ...
      <section className="intro-section">
        <div className="max-with">
          ...
          <Slideshow data={state.data} state={state} />
              ...
              <div className="card">
                <div className="box" id="one">
                  <p className="text">
                    ...
                    to help people reduce their stress and get in some servings
              ...
              <div className="card">
                <div className="box" id="one">
                  <p className="text">
                    ...
                    questions that will help us pick the fruit that will be most
                    effective in helping you de-stress. Then, once a day, you’ll
                    listen to a lovely relaxing 6-minute exercise and eat your
                    customized fruit at the end.
                  </p>
                  <div className="img ilustrations">
                    <a href="" className="brand-logo">
                      <img
