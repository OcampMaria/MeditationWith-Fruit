  ...
  const slideData = [
    {
      id: "slide1", 
      imagePath: {img1},  
      paragraph: "A lot of people are really stressed right now. One way people deal with stress is eating. Our program is designed to help people reduce their stress and get in some servings of fruit at the same time!"
    }, 
    {
      id: "slide2", 
      imagePath: "{img2}",  
      paragraph: "In this 1 week program, you’ll start out by answering some questions that will help us pick the fruit that will be most effective in helping you de-stress. Then, once a day, you’ll listen to a lovely relaxing six minute exercise and eat your customized fruit at the end."
    }, 
    {
      id: "slide3", 
      imagePath: "{img3}",  
      paragraph: "Repeat 7 days.Our Research shows that simply eating your fruit will help bring that sense of relaxation     automatically! It’s a #bodyhack that we hope will help manage stress and eat more fruit."
    }
  ];
