      ...
      <nav className="">
        ...
        <div className="collapse navbar-collapse" id="navbarText">
          ...
          <ul className="nav navbar-nav">
                ...
                <li className="nav-items active">
                    <a className="page-scroll nav-left-text" href="/profile"><p>PROFILE</p></a>
                </li>
                <li className="nav-items active">
                    <a className="page-scroll nav-left-text" href="/quiz"><p>QUIZ</p></a>
                </li>
                <li className="nav-items active">
                    <a className="page-scroll nav-left-text" href="/audioplayer"><p>SESSION</p></a>
                </li>
